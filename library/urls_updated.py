...
urlpatterns = [
   ...
   path('library/mark-attendance/', views.mark_attendance, name='mark_attendance'),
   ...
   # Add the following URL patterns for installment payments
   path('institution/<str:institution_uid>/subscription/<int:subscription_id>/installment-payments/', views.installment_payment_list, name='installment_payment_list'),
   path('institution/<str:institution_uid>/subscription/<int:subscription_id>/installment-payments/add/', views.add_installment_payment, name='add_installment_payment'),
   path('institution/<str:institution_uid>/subscription/<int:subscription_id>/installment-payments/edit/<int:installment_id>/', views.edit_installment_payment, name='edit_installment_payment'),
   path('institution/<str:institution_uid>/subscription/<int:subscription_id>/installment-payments/delete/<int:installment_id>/', views.delete_installment_payment, name='delete_installment_payment'),
]
