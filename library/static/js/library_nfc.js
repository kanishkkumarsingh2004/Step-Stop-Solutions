document.addEventListener('DOMContentLoaded', () => {
    console.log('Script loaded: library_nfc.js'); // Debug: Script initialization
    ...
    // Check NFC allocation (original workflow)
    async function checkNfcAllocation(serialNumber) {
        try {
            ...
            const response = await fetch('/check_nfc_allocation/', {
                ...
                body: JSON.stringify({ nfc_serial: serialNumber, library_id: libraryId })
            });
    ...
    if (form && activateButton && userSelect) {
        ...
        form.addEventListener('submit', async (e) => {
            ...
            console.log('Form data:', { nfcSerial, userId, libraryId }); // Debug
