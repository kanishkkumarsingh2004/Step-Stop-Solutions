...
urlpatterns = [
    ...
    path('expenses-data/<str:gym_id>/', views.gym_expenses_data, name='gym_expenses_data'),
    ...
    path('payment/<str:gym_id>/<int:plan_id>/', views.gym_payment_page, name='gym_payment_page'),
    path('payment-success/<str:gym_id>/<int:plan_id>/', views.gym_payment_success, name='gym_payment_success'),
